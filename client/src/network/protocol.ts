...
export type P2PMessage =
  ...
  | { type: "game_setup"; state: GameState; events: GameEvent[]; legalActions: GameAction[]; autoPassRecommended?: boolean }
  | { type: "action"; action: GameAction }
  | { type: "state_update"; state: GameState; events: GameEvent[]; legalActions: GameAction[]; autoPassRecommended?: boolean }
